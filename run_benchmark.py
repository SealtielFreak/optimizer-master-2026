...
ALGORITHMS = [
    ...
    AlgorithmSpec(name="DEAL_MODE", cls=MGSHADE, kwargs=dict(stats_mode='mode')),
    AlgorithmSpec(name="DEAL_MEDIAN", cls=MGSHADE, kwargs=dict(stats_mode='median')),
    AlgorithmSpec(name="DEAL_MEAN", cls=MGSHADE, kwargs=dict(stats_mode='mean')),
    AlgorithmSpec(name="DEAL_S", cls=MGSHADE, kwargs=dict(stats_mode='sorted')),
]
